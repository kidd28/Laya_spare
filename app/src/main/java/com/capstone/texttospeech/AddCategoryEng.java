...
public class AddCategoryEng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_category_eng);
            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(
                            new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    if (uriTask.isSuccessful()) {
                                        ...
                                        reference.child(categoryName).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                startActivity(new Intent(AddCategoryEng.this, Category.class));
                                                finish();
                                            }
                                    ...
                                    Toast.makeText(AddCategoryEng.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                                }
                            })
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AddCategoryEng.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
